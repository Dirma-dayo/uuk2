...
export function ItemCard({ item, mode, counter, onChange, onAction }: ItemCardProps) {
  return (
    <Card className="bg-gray-800 border border-gray-700 p-4 flex flex-col items-center gap-3 shadow-lg text-white">
      ...
      <div className="flex items-center gap-2 mt-2">
        <Button className="px-2 py-1 bg-gray-700 hover:bg-gray-600 rounded" onClick={() => onChange(-1)}>-</Button>
